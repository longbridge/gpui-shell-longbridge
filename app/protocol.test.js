...
function runVectors() {
  ...
  const intraday = decodeSecurityIntradayResponse(
    bytes(
      ...
      0x55,
      0x53,
      // All four sessions retain decimal strings and their server session.
      0x12,
      0x16,
      0x0a,
      0x0a,
  ...
  check(
    intraday.symbol === "AAPL.US" &&
      ...
      intraday.lines[3].price === "189.423456" &&
      intraday.lines[2].volume === 102n,
    "SecurityIntradayResponse preserves decimal lines and all sessions",
  );
